...
Configuration file:  `/etc/dashcore/mastercoin.conf`  
...
dashcore user and group.  Access to mastercoin-cli and other dashd rpc clients
can then be controlled by group membership.

3b) Mac OS X

Binary:              `/usr/local/bin/dashd`  
Configuration file:  `~/Library/Application Support/DashCore/mastercoin.conf`  
...
Copy org.mastercoin.dashd.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.mastercoin.dashd.plist`.
...
You will need to modify org.mastercoin.dashd.plist if you intend to use it as a
