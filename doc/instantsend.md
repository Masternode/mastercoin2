...
This mechanism has been integrated into Bitcore-Node-Mastercoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masternode/insight-api-mastercoin#web-socket-api](https://github.com/masternode/insight-api-mastercoin#web-socket-api)
* API: [https://github.com/masternode/insight-api-mastercoin#instantsend-transactions](https://github.com/masternode/insight-api-mastercoin#instantsend-transactions)
...
By default, the Mastercoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mastercoin Core daemon:
