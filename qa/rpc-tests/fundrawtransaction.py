...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid mastercoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid mastercoin address" in e.error['message'])
        ...
        # send 12 MASTERCOIN to msig addr
