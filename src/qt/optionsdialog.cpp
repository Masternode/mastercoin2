    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MASTERCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("MASTERCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MASTERCOIN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("MASTERCOIN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("MASTERCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MASTERCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MASTERCOIN-traditional"), QVariant("trad"));
