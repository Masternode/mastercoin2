...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Mastercoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "mastercoin",               "masternode",             &masternode,             true,  {} },
    { "mastercoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "mastercoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "mastercoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "mastercoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "mastercoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
